...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="side-menu">
            ...
            <li class=""><a href="edit_record.php"><i class="fa-solid fa-pen-to-square"></i>ပြင်ဆင်ခဲ့သည့်မှတ်တမ်း</a></li>
            <li class=""><a href="record.php"><i class="fa-solid fa-pen-to-square"></i>မှတ်တမ်း</a></li>
            <li class=""><a href="user_list.php"><i class="fa-solid fa-user"></i>User</a></li>
