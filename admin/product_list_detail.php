                    ...
                    <table>
                        ...
                        <tbody id="data">
                            ...
                            <tr>
                                ...
                                <td><a href="edit_product.php?id=<?php echo $row['id'] ?>"><i class="fa-solid fa-pen"></i>Edit</a> | <a href="product_list.php?action=delete&id=<?php echo $row['id'] ?>"><i class="fa-solid fa-trash"></i>Delete</a></td>
                            </tr>
                            <?php } ?>
